...
- Módulo Go inicializado (`go mod init github.com/Gabriel-Schiestl/pprof-analyzer`)
...
```
PASS  github.com/Gabriel-Schiestl/pprof-analyzer/internal/domain       (3 testes)
PASS  github.com/Gabriel-Schiestl/pprof-analyzer/internal/storage      (9 testes)
PASS  github.com/Gabriel-Schiestl/pprof-analyzer/internal/app          (7 testes)
PASS  github.com/Gabriel-Schiestl/pprof-analyzer/internal/report       (2 testes)
PASS  github.com/Gabriel-Schiestl/pprof-analyzer/internal/collector    (5 testes)
```
